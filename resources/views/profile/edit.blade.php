...
<div class="wp-container">
    <div class="wp-header">
        <div class="wp-header-content">
            <h1 class="wp-title">Edit My Profile</h1>
            <div class="wp-actions">
                <a href="{{ route('user-profile.show') }}" class="wp-button wp-button-secondary">
    ...
    <div class="wp-content">
        <div class="wp-card">
            <div class="wp-card-header">
                ...
                <p class="wp-card-description">Update your profile details and settings</p>
            </div>
                ...
                <div class="wp-profile-layout">
                    ...
                    <div class="wp-avatar-section">
                        <div class="wp-avatar-container">
                            ...
                            <form action="{{ route('profile.avatar') }}" method="POST" enctype="multipart/form-data" class="wp-avatar-form" onsubmit="return validateAvatarUpload(this)">
                                @csrf
                    ...
                    <div class="wp-form-section">
                        <form action="{{ route('user-profile.update') }}" method="POST" class="wp-form" onsubmit="return validateProfileForm(this)">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="wp-form-grid">
                                ...
                                <div class="wp-form-column">
                                    ...
                                    <div class="wp-form-field">
                                        <label class="wp-label">Username</label>
                                        <input type="text" name="username" value="{{ old('username', $user->username) }}" 
                                               class="wp-input" maxlength="50">
                                    </div>
                                </div>
...
function validateProfileForm(form) {
    ...
    if (name.length < 2) { alert('Full name must be at least 2 characters long.'); form.name.focus(); return false; }
    if (name.length > 255) { alert('Full name cannot exceed 255 characters.'); form.name.focus(); return false; }
